...
| 9 | Fiber with the macros: a fiber goal in Settings (default 14 g per 1,000 kcal), fiber per serving on stack supplements, and a Fiber bar on Today counting food plus the stack taken today | In progress |
