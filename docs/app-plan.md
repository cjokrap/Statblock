...
| 5 | Today dashboard: calories as HP, macros, quests, weekly bosses, water quick-add, daily stack button (plus managing the stack in Settings), CHA quick log, weigh-in, training feed with PRs, skip buttons and "I'm recovered", undo for each tap. Streaks wait for the engine | In progress |
