...
| 13 | Recent tab on Add food (last 7 days, one tap to add), ability scores earned over weeks (rules v2 ladder, progress bars on Today), and a fresh start: XP and scores count from the first app use, not Liftosaur history | In progress |
