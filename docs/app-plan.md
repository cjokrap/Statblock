...
| 3 | Packaged foods: live USDA FoodData Central search under whole-food results, product page, and save-on-first-log into `foods` (server-side, secret key). Moved up because branded foods were the first gap in daily use | In progress |
